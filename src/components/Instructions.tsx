...
const Instructions: React.FC = () => {
  return (
    <div className="mb-4 bg-blue-50 p-4 rounded-lg">
      <h3 className="text-lg font-semibold mb-2">كيفية اللعب:</h3>
      ...
      <p className="mt-2 text-sm text-gray-600">تلميح: فكر استراتيجيًا في مكان وضع المكعبات للحصول على أفضل النتائج!</p>
    </div>
  );
};
